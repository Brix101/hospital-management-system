...
{
    public partial class frmAdmin_Doctor : Form
    {
        SqlConnection con = Database.db_connect();
        int id;
        int x = RealTimeUpdate.x();
        public frmAdmin_Doctor()
        {
            InitializeComponent();
        ...
        {
            using (dlUser dl = new dlUser(0, 0, 0, "Doctor"))
            {
                dl.ShowDialog();
            }
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (dlUser dl = new dlUser(infoid, userid, addressid, "Doctor"))
                {
                    dl.ShowDialog();
                }
            }
        ...
        private void frmAdmin_Doctor_VisibleChanged(object sender, EventArgs e)
        {
            LoadData(txtSearch.Text);
            Method.lvbtn(lvUser, btnUpdate, btnDelete);
        }
