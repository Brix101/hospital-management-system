...
{
    public partial class frmAdmin_Accountant : Form
    {
        SqlConnection con = Database.db_connect();
        int id;
        int x = RealTimeUpdate.x();
        public frmAdmin_Accountant()
        {
            InitializeComponent();
        ...
        {
            using (dlUser dl = new dlUser(0, 0, 0, "Accountant"))
            {
                dl.ShowDialog();
            }
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                using (dlUser dl = new dlUser(infoid, userid, addressid, "Accountant"))
                {
                    dl.ShowDialog();
                }
            }
